...
function buildSystemPrompt(): string {
  return [
    ...
    'FOCO DEL PRODUCTO: jóvenes latinos en Estados Unidos y en Latinoamérica cuya meta es estudiar en universidades de EE. UU. (TOEFL). Prefiere contextos de admisiones, becas, vida universitaria, oficinas internacionales, clubes escolares y experiencias biculturales latino-estadounidenses.',
      ...
      activities: [
        {
          ...
          supportLevel: 'guided',
          instructions: `Lee (o escucha) el anuncio de la oficina internacional sobre ${topicLower} y responde.`,
          transcript: `Attention international and Latino students: our new ${topic} program starts next Monday. Sessions will take place at the International Students Office after classes. If you want to join, sign up before Friday and bring your student ID.`,
          stem: 'What must students do to join the program?',
          options: [
            'Pay a fee on Monday',
            'Sign up at the International Students Office before Friday with their ID',
            'Talk to the principal directly',
            'Nothing, everyone is enrolled automatically',
          ],
          correctIndex: 1,
          explanation: 'El anuncio pide inscribirse en la oficina internacional antes del viernes con el carné.',
        },
        {
          kind: 'gap_fill',
          skill: 'language_use',
